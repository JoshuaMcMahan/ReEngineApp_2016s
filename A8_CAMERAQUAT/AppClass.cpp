...
void AppClass::InitVariables(void)
{
	...
	//Self Made Camera
	qCamera->SetPosition(glm::vec3(0.0f, 2.5f, 15.0f));	//Position
	qCamera->SetTarget(glm::vec3(0.0f, 2.5f, 0.0f));	//What Im Looking At
	qCamera->SetUp(REAXISY);							//What is up

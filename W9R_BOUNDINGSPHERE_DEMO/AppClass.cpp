...
{
	super::InitWindow("BoundingSphereDemo"); // Window Name
...
void AppClass::Update(void)
{
	...
	ArcBall();
	matrix4 m4Sphere = glm::translate(m_pBS0->m_v3Center) * glm::scale(vector3(m_pBS0->m_fRadius) * 2.0f); //mult by 2 cause ReEngine Sphere takes the diameter, not radius
